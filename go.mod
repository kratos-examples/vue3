module github.com/yylego/kratos-examples

go 1.25.0

require (
	github.com/yylego/kratos-compare v0.0.5
	github.com/yylego/kratos-examples/demo1kratos v0.0.2
	github.com/yylego/kratos-examples/demo2kratos v0.0.2
...
require (
	...
	github.com/yylego/must v0.0.0 // indirect
	github.com/yylego/mutexmap v0.0.0 // indirect
	github.com/yylego/osexec v0.0.0 // indirect
	github.com/yylego/printgo v0.0.0 // indirect
	github.com/yylego/rese v0.0.0 // indirect
